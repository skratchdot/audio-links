/*eslint strict: 0, prefer-template: 0, no-console: 0 */
'use strict';
...
gulp.task('build-helpers', function (next) {
  ...
  build('./src/updaters', './updaters/', './src/Updaters.js');
  return next;
});
...
gulp.task('build', ['build-helpers', 'lint', 'transpile', 'build:prod', 'build:dev', 'test']);
